...
function scene:create( event )
    ...
    vidasText = display.newText (UIGroup, "Vidas: " .. vidas, display.contentCenterX - 100, display.contentHeight/2*0.1, native.systemFont, 36)

    pontosText = display.newText (UIGroup, "Pontos: " .. pontos, display.contentCenterX + 100, display.contentHeight/2*0.1, native.systemFont, 36)
